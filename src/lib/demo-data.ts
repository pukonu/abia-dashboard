  ...
  },
  {
    ...
    thematicAreas: [
        ...
        domains: [
          {
            ...
            indicators: [
              { name: "Violent crime incidents", unit: "cases/week", direction: "lower_is_better", target: 10, targetSource: "State Plan", base: 19, nigeria: 34, trend: 0.2, jitter: 0.12 },
              { name: "Kidnapping cases", unit: "cases/week", direction: "lower_is_better", target: 1, targetSource: "State Plan", base: 3.2, nigeria: 7.5, trend: 0.25, jitter: 0.2 },
              { name: "Armed robbery incidents", unit: "cases/week", direction: "lower_is_better", target: 5, targetSource: "State Plan", base: 8.4, nigeria: 15, trend: 0.18, jitter: 0.14 },
              { name: "Cult-related incidents", unit: "cases/week", direction: "lower_is_better", target: 2, targetSource: "State Plan", base: 4.1, nigeria: 9, trend: 0.2, jitter: 0.16 },
              { name: "Average response time", unit: "minutes", direction: "lower_is_better", target: 15, targetSource: "State Plan", base: 24, nigeria: 41, trend: 0.15, jitter: 0.08 },
            ],
          },
          {
            name: "Community Policing",
            indicators: [
              { name: "Vigilante/neighbourhood watch coverage", unit: "%", direction: "higher_is_better", target: 90, targetSource: "State Plan", base: 74, nigeria: 51, trend: 0.1, jitter: 0.03 },
              { name: "Planned patrols completed", unit: "%", direction: "higher_is_better", target: 95, targetSource: "State Plan", base: 87, nigeria: 70, trend: 0.05, jitter: 0.04 },
              { name: "Community security meetings held", unit: "meetings/week", direction: "higher_is_better", target: 40, targetSource: "State Plan", base: 28, nigeria: 18, trend: 0.08, jitter: 0.1 },
              { name: "Tip-offs acted on within 24 hours", unit: "%", direction: "higher_is_better", target: 85, targetSource: "State Plan", base: 71, nigeria: 48, trend: 0.1, jitter: 0.06 },
            ],
          },
        ],
      },
      {
        ...
        description: "Readiness for emergencies, critical assets and road safety.",
        frequency: "monthly",
        domains: [
          {
            ...
            indicators: [
              ...
              { name: "Functional emergency vehicles", unit: "count", direction: "higher_is_better", target: 40, targetSource: "State Plan", base: 28, nigeria: 20, trend: 0.08, jitter: 0.05 },
              { name: "Joint security operations this month", unit: "operations", direction: "higher_is_better", target: 12, targetSource: "State Plan", base: 9, nigeria: 6, trend: 0.1, jitter: 0.12 },
            ],
          },
          {
            name: "Critical Asset Protection",
            indicators: [
              { name: "Critical assets under protection", unit: "count", direction: "higher_is_better", target: 120, targetSource: "State Plan", base: 96, nigeria: 70, trend: 0.06, jitter: 0.04 },
              { name: "Asset protection coverage", unit: "%", direction: "higher_is_better", target: 95, targetSource: "State Plan", base: 82, nigeria: 61, trend: 0.08, jitter: 0.03 },
            ],
          },
          {
            name: "Road Safety",
            indicators: [
              ...
              { name: "Road traffic injuries", unit: "injuries/month", direction: "lower_is_better", target: 40, targetSource: "State Plan", base: 62, nigeria: 95, trend: 0.12, jitter: 0.1 },
              { name: "FRSC / traffic enforcement stops", unit: "stops/month", direction: "higher_is_better", target: 800, targetSource: "State Plan", base: 640, nigeria: 420, trend: 0.05, jitter: 0.08 },
            ],
          },
        ],
      },
...
export function buildDemoData(): DashboardData {
  ...
  for (const [sIdx, s] of SECTOR_SPECS.entries()) {
    ...
    for (const ta of s.thematicAreas) {
      ...
      thematicAreas.push({
        ...
        weight: ta.weight ?? 1,
        // Demo data has no executive sector-dashboard frameworks; live seeds set the flag.
        is_sector_dashboard: false,
      });
  ...
  const dashboards: DashboardData["dashboards"] = [
    ...
    {
      id: "dash-security-glance",
      name: "Security at a Glance",
      description: "Crime, response capacity, community policing and road safety for the Security sector.",
      scope: "sector",
      sector_id: "sec-security",
      lga_id: null,
      published: true,
      sort_order: 0,
    },
    {
      id: "dash-education-executive",
      name: "Education Executive Dashboard",
      description:
        "Executive view of access, learning outcomes and classroom standards for the Education sector.",
      scope: "sector",
      sector_id: "sec-education",
      lga_id: null,
      published: true,
      sort_order: 0,
    },
  ...
  const dashboardWidgets: DashboardData["dashboardWidgets"] = [
    ...
    {
      id: "dw-security-stats",
      dashboard_id: "dash-security-glance",
      chart_type: "stat",
      title: "Public safety briefing",
      indicator_ids: [
        ind("Violent crime incidents"),
        ind("Kidnapping cases"),
        ind("Average response time"),
    ...
    },
    {
      ...
      dashboard_id: "dash-security-glance",
      chart_type: "bar",
      title: "Response & coverage scores",
      indicator_ids: [
        ind("Vigilante/neighbourhood watch coverage"),
        ind("Planned patrols completed"),
        ind("Tip-offs acted on within 24 hours"),
        ind("Emergency readiness score"),
    ...
    {
      id: "dw-edu-stats",
      dashboard_id: "dash-education-executive",
      chart_type: "stat",
      title: "Executive briefing — access & outcomes",
      indicator_ids: [
        ind("Net primary enrollment"),
        ind("Primary completion rate"),
        ind("Out-of-school children"),
    ...
    },
    {
      ...
      indicator_ids: [
        ind("Net primary enrollment"),
        ind("WAEC 5 credits incl. Eng & Maths"),
        ind("P4 pupils meeting literacy benchmark"),
